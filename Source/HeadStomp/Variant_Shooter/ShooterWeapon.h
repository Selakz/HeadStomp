 ...
 */
UCLASS(abstract)
class HEADSTOMP_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(ReplicatedUsing = OnRep_MagazineSize, EditAnywhere, BlueprintReadOnly, Category="Ammo")
	int32 MagazineSize = 10;

	/** Number of bullets in the current magazine */
	UPROPERTY(ReplicatedUsing = OnRep_CurrentBullets, BlueprintReadOnly, Category="Ammo")
...
protected:
	...
	void ServerFireProjectile(const FVector& TargetLocation);
